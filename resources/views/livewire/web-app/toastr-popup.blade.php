...
<div x-cloak x-data="toastr" x-show="show"
    ...
    class="fixed cursor-pointer top-8 right-8 bg-black z-50 shadow-lg rounded-xl">
    <div :class="type == 'success' ? 'from-green-700/40' : 'from-red-700/40'" class="size-full py-4 pl-6 pr-24 bg-gradient-to-r bg-white/10 rounded-xl flex justify-around items-center gap-6">
        ...
        <div class="h-min grid grid-cols-1 gap-2 text-white">
            <div class="text-xl inter-700 capitalize" x-text="type">Success</div>
            <div class="text-sm inter-700 whitespace-nowrap" x-text="message">Updated Successfully</div>
        </div>
    </div>
