            ...
            <div>
                ...
                <div class="mx-auto w-1/2">
                    <form wire:submit="submit" class="bg-gradient-to-tr shadow-2xl shadow-blue-700/30 rounded-3xl from-blue-700 via-transparent to-blue-700 p-0.5">
                        <div class="size-full p-8 rounded-3xl bg-black">
                            <div class="h-min grid grid-cols-1 gap-4 text-white">
                                <div class="flex justify-between items-center gap-4">
                                    <div class="h-min grid grid-cols-1 gap-2 w-full">
                                        <div class="text-xl inter-200">Name</div>
                                        <div>
                                    ...
                                    <div class="h-min grid grid-cols-1 gap-2 w-full">
                                        <div class="text-xl inter-200">Phone no</div>
                                        <div>
                                            <input x-mask="9999999999" wire:model="phoneno" type="text" class="w-full inter-400 text-lg bg-transparent border border-blue-700 rounded-xl py-2 px-4 outline-none caret-blue-700">
                                        </div>
                                        <div>
                                            @error('phoneno')
                                            <span wire:transition.in.duration.500ms="scale-y-100"
                                ...
                                <div class="flex justify-between items-center gap-4">
                                    <div class="h-min grid grid-cols-1 gap-2 w-full">
                                        ...
                                        <div>
                                            <input wire:model="password" type="text" class="w-full inter-400 text-lg bg-transparent border border-blue-700 rounded-xl py-2 px-4 outline-none caret-blue-700">
                                        </div>
                                        <div>
                                            @error('password')
                                            <span wire:transition.in.duration.500ms="scale-y-100"
                                    ...
                                    <div class="h-min grid grid-cols-1 gap-2 w-full">
                                        <div class="text-xl inter-200">Confirm Password</div>
                                        <div>
                                            <input wire:model="phoneno" type="text" class="w-full inter-400 text-lg bg-transparent border border-blue-700 rounded-xl py-2 px-4 outline-none caret-blue-700">
                                        </div>
                                        <div>
                                            @error('phoneno')
                                            <span wire:transition.in.duration.500ms="scale-y-100"
                                ...
                                <div class="flex justify-center">
                                    <button type="submit" wire:click="submit" wire:loading.class="pointer-events-none" wire:target="submit" class="hover:bg-blue-700 w-32 h-14 hover:shadow-lg hover:shadow-blue-700/50 transition-colors duration-300 cursor-pointer bg-gradient-to-bl from-blue-700 via-transparent to-blue-700 whitespace-nowrap p-0.5 rounded-xl">
                                        <div class="size-full bg-black rounded-xl inter-200 text-xl flex justify-center items-center">
                                            <div wire:loading.class="hidden pointer-events-none" wire:target="submit">Sign Up</div>
                    ...
                    <div class="flex justify-center text-white py-10 text-lg inter-600">
                        <a href="/sign-in" wire:navigate>Already have an account? <span class="text-blue-700">Sign In</span></a>
                    </div>
                </div>
            </div>
        </div>
