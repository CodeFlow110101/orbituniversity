    ...
    <form wire:submit="submit" class="size-full flex items-center justify-center bg-black rounded-2xl">
        <div class="h-min w-full px-8 grid grid-cols-1 gap-3 text-white">
            <div class="h-min grid grid-cols-1 gap-2">
                <div class="text-lg inter-300">Password</div>
                <div>
            ...
            <div class="h-min grid grid-cols-1 gap-2">
                <div class="text-lg inter-300">Retype Password</div>
                <div>
                    <input wire:model="password_confirmation" type="password" class="w-full inter-400 text-lg bg-transparent border border-red-700 rounded-xl py-2 px-4 outline-none caret-red-700">
                </div>
                <div>
