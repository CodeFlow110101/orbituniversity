        ...
        <div class="h-min grid grid-cols-1 gap-6 w-full">
            <div>
                ...
                <div class="mx-auto w-4/12">
                    <form wire:submit="submit" class="bg-gradient-to-tr shadow-2xl shadow-red-700/30 rounded-3xl from-red-700 via-transparent to-red-700 p-0.5">
                        <div class="size-full p-10 rounded-3xl bg-black">
                            <div class="h-min grid grid-cols-1 gap-6 text-white">
                                ...
                                <div class="h-min grid grid-cols-1 gap-2">
                                    ...
                                    <div>
                                        <input wire:model="password" type="password" class="w-full inter-400 text-lg bg-transparent border border-red-700 rounded-xl py-2 px-4 outline-none caret-red-700">
                                    </div>
                                    <div>
                                        @error('password')
                                        <span wire:transition.in.duration.500ms="scale-y-100"
                                ...
                                <div class="flex justify-center">
                                    <button type="submit" wire:click="submit" wire:loading.class="pointer-events-none" wire:target="submit" class="hover:bg-red-700 w-32 h-14 hover:shadow-lg hover:shadow-red-700/50 transition-colors duration-300 cursor-pointer bg-gradient-to-bl from-red-700 via-transparent to-red-700 whitespace-nowrap p-0.5 rounded-xl">
                                        <div class="size-full bg-black rounded-xl inter-500 text-xl flex justify-center items-center">
                    ...
                    <div class="flex justify-center text-white py-10 text-lg inter-600">
                        <a href="/programs" wire:navigate>Don't have an account? <span class="text-red-700">Sign Up</span></a>
                    </div>
                </div>
            </div>
        </div>
